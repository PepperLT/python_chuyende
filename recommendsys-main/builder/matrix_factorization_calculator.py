...
if __name__ == '__main__':
    ...
    timestamp = datetime.now().strftime('%Y%m%d_%H%M%S') # Định dạng YYYYMMDD_HHMMSS
    MF = MatrixFactorization(save_path='./models/funkSVD/{}/'.format(timestamp), max_iterations=40)
